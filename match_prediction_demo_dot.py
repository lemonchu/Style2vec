...
def main(args):
    ...
    # 计算 cosine 相似度
    alpha = 4.0 # Hyperparameter for scaling the scores
    scores = torch.matmul(candidate_embs, query_emb) ** alpha
    # 对 scores 进行 softmax 得到概率分布
    # probs = F.softmax(scores, dim=0)
    probs = scores / torch.sum(scores, dim=0)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="./font_style2vec_dot.pth",
